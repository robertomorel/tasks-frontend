...
export default class Agenda extends Component {
    ...
    */
    componentDidMount = async () => {
        ...
        const savedTasks = JSON.parse(data) || initialState; // -- [] caso não exista tasks

        // -- Salva o estado
        this.setState({
            showDoneTasks: savedTasks.showDoneTasks
        }, this.filterTasks);
    ...
    */
    ...
    loadTasks = async () => {
        ...
        try {
            ...
            // -- Pegar a data com última hr do dia. Até o final do dia.
